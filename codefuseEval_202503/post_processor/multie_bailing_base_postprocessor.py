...
class MultieBailingBasePostProcessor(BasePostProcessor):
    ...
    def post_process(self, data: Dict, language: str, task_mode: str, dataset_name: str, **kwargs) -> Dict:
        ...
        if text:
            ...
            text = ""
        if language.lower() == "cpp":
            new_code, testcode = self.deal_cpp(text, data)
        elif language.lower() == "python":
            new_code, testcode = self.deal_python(text, data)
        elif language.lower() == "java":
            new_code, testcode = self.deal_java(text, data)
        elif language.lower() == "php":
            new_code, testcode = self.deal_php(text, data)
        elif language.lower() == "sh" or language.lower() == "shell":
            new_code, testcode = self.deal_shell(text, data)
        elif language.lower() == "js" or language.lower() == "javascript":
            new_code, testcode = self.deal_js(text, data)
        elif language.lower() == "ts" or language.lower() == "typescript":
            new_code, testcode = self.deal_ts(text, data)
        elif language.lower() == "cs" or language.lower() == "csharp":
            new_code, testcode = self.deal_csharp(text, data)
        elif language.lower() == "go":
            new_code, testcode = self.deal_go(text, data)
