...
class BLEURT(evaluate.Metric):
    ...
    def _download_and_prepare(self, dl_manager):
        ...
        if self.config_name == "default":
            ...
            self.config_name = "BLEURT-20-D12"
        ...
        #补充一个模型下载和解压的链接
        if not os.path.exists(os.path.join(model_path, checkpoint_name)):
            os.system(f"wget -O {model_path}/"+checkpoint_name+".zip "+CHECKPOINT_URLS[checkpoint_name])
            os.system(f"unzip {model_path}/"+checkpoint_name+".zip")
